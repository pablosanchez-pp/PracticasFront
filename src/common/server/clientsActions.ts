...
export async function listClients(params?: ListParams, token?: string): Promise<Client[]> {
  try {
...
export async function getClientById(id: string, token?: string): Promise<Client | null> {
  try {
...
export async function getClientsByName(query: string, token?: string): Promise<Client[]> {
  try {
...
export async function getClientsByEmail(email: string, token?: string): Promise<Client[]> {
  try {
